...
//!---<<<<< <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Clash_Display_Bold >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> >>>>>
  ...
  Text bold15({TextDecoration ?  textDecoration,
    required String text, Color color = Colors.black, double? height}) {
    return Text(
      text,
      style: TextStyle(
  ...
  Text bold16({TextDecoration ?  textDecoration,
    required String text, Color color = Colors.black, double? height,TextAlign textAlign = TextAlign.left,}) {
    return Text(
