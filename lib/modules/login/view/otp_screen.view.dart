            ...
            child: Scaffold(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        KStyles().med15(
                          text:
                              '${loginCtrl.countryCode} ${loginCtrl.phoneCtrl.text} ',
                          color: kBorderGrey,
                        ),
                        InkWell(
                          radius: 30.r,
                    ...
                    loginCtrl.isResendEnabled
                        ? TextButton(
                            ...
                            child: KStyles()
                                .med16(text: 'Resend OTP', color: kBlue))
                        : Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              KStyles().med15(text: 'Resend OTP in '),
                              KStyles().med15(
                                  text: '${loginCtrl.start} seconds',
                                  color: kRed)
                            ],
                          ),
                  ],
              ...
              floatingActionButton: Padding(
                ...
                child: CommonButtonWidget(
                  ...
                  text: 'Continue',
                  color:
                      loginCtrl.pinCtrl.text.length == 4 ? kBlue : kBorderGrey,
                ),
              ),
